-- دوري دراية: (1) تفاعلات (إيموجي) على التصريحات والصور من أي كابتن أو الإدارة،
-- (2) اقتصاد صور جديد: صورة عادية بـ25 دراية تُنشر فورًا باسم فريق الكابتن، وحجز
-- "يوم إبراز" بـ75 دراية يُظهر صورة الفريق كإعلان يملأ الشاشة لأول من يفتح الموقع
...
-- ============ 3) صورة عادية من كابتن — 25 دراية، تُنشر فورًا بلا اعتماد ============
...
-- ============ 4) حجز "يوم الإبراز" — 75 دراية، يحتاج اعتماد الإدارة ============
